...
public class JavaAgentApplication {
	...
	public static void premain(String agentArgs, Instrumentation inst) {
		...
		try {
			...
			String jarLocation = discoverThisClassJarLocation(JavaAgentApplication.class);
			CodeUsageAgentContextClassLoader contextClassLoader = 
					new CodeUsageAgentContextClassLoader(JavaAgentApplication.class.getClassLoader(), jarLocation);
		} catch (Throwable e) {
			e.printStackTrace();
		}
	...
	/**
	 * This code is taken from <a href="https://stackoverflow.com/questions/1983839/determine-which-jar-file-a-class-is-from">stackoverflow.com</a>.
	 * 
	 * @return
